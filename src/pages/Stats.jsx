...
export default function Stats() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="bg-white rounded-3xl p-8 sm:p-12 shadow-sm max-w-md mx-auto">
        <p className="text-center font-medium mb-8">By Interaction Type</p>
        <PieChart width={340} height={340} className="mx-auto">
          <Pie data={data} cx="50%" cy="50%" innerRadius={80} outerRadius={130} dataKey="value" paddingAngle={5}>
